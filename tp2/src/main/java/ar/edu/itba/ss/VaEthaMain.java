...
public class VaEthaMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (etha <= ethaMax) {
            ...
            OffLaticeVaEthaCsvWorker ethaCsvWorker = new OffLaticeVaEthaCsvWorker(handler.getArgument("-O")+'_'+offLaticeParameters.cimParameters.l +'_' + offLaticeParameters.cimParameters.n + ".csv", timeStart,timeEnd,aux);
