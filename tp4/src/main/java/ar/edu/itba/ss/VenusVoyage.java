...
public class VenusVoyage {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Initialize CSV File
        String fileName = String.format(argumentHandler.getArgument("-O") + "venus-dt-%s-start-%s.csv", dt, timeParameters.getRawStart() + timeParameters.getStartUnits());
