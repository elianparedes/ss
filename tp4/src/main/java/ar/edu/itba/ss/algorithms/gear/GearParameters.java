...
public class GearParameters extends AlgorithmParameters {
    ...
    private final List<Vector> alpha;
    private final int maxIterations;

    public GearParameters(Vector initialSpeed, Vector initialAcceleration, Vector initialPosition, List<Vector> alpha, Force force, double mass, double dt, double tf, int maxIterations) {
